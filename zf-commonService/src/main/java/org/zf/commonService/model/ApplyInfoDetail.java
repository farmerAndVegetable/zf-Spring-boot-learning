 ...
 */
@XStreamAlias("Detail")
public class ApplyInfoDetail extends Body implements Serializable {
	...
	public ApplyInfoDetail(String zZKSID, String zZKSDM) {
		super();
		ZZKSID = zZKSID;
		ZZKSDM = zZKSDM;
	}
	...
	public static void main(String[] args) {
    	ApplyInfoDetail applayInfo=new ApplyInfoDetail();
